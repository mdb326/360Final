...
void loop() {
  ...
  if (cmd.params[0] == 2) {
    ...
    if (nicla_flag != 0) {// checks if new yaw occurs
        ...
        nicla_yaw = _yaw + des_yaw - 0.02; // add the offset in yaw to the current yaw for movement.
        ...
        cmd.params[1] = cmd.params[1] - 0.32;
    } 
    else{
      cmd.params[1] = cmd.params[1] - 0.02;
      int seconds = clockTime / 10000000;
      nicla_yaw = senses[5] + 16 / seconds;
    }
